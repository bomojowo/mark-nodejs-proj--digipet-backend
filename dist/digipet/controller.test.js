...
describe("trainDigipet", () => {
    it("increases digipet discipline by 10 and decreases happiness by 5", () => {
        ...
        // assert
        expect(model_1.getDigipet()).toStrictEqual({
            happiness: model_1.INITIAL_DIGIPET.nutrition - 5,
            nutrition: model_1.INITIAL_DIGIPET.nutrition,
            discipline: model_1.INITIAL_DIGIPET.nutrition + 10,
        });
    });
    it("cannot increase discipline past 100", () => {
        // setup
        model_1.setDigipet({ happiness: 50, nutrition: 50, discipline: 100 });
        // act
        controller_1.trainDigipet();
        // assert
...
describe("rehomeDigipet", () => {
    test("when there is a current digipet, it removes current digipet in order for you to hatch a new one", () => {
        ...
        // assert
        expect(controller_1.rehomeDigipet).toHaveProperty("digipet", undefined);
    });
});
